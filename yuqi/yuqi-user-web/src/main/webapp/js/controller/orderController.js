...
app.controller('orderController' ,function($scope,$controller   ,orderService){	
	...
	$scope.findPage=function(page,rows){
		...
		orderService.showName().success(
			function(response){
				...
				orderService.findPage(page,rows,loginName).success(
					function(response){
    ...
    $scope.updateStatus=function(id,status){
        orderService.updateStatus(id,status).success(function (response) {
            if(response.success){
                alert(response.message);
    ...
    $scope.updateEastimate=function(id,est){
        orderService.updateEastimate(id,est).success(function (response) {
            if(response.success){
                alert(response.message);
                window.location.reload();
            }
