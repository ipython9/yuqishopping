...
import com.yuqi.mapper.TbUserMapper;
import com.yuqi.pojo.TbUser;
import com.yuqi.pojo.TbUserExample;
import com.yuqi.pojo.TbUserExample.Criteria;
...
//		});
	...
	public TbUser findUserByUserid(String username) {
		...
		return userMapper.selectByExample(tbUserExample).get(0);
	}
}
