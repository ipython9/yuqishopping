...
app.controller('cartController',function($scope,$http,cartService){
    ...
    $scope.findContent=function(){
        $http.get("../itemModel/findContent.do").success(
            function (response) {
                $scope.list=response;
            }
        )
    ...
    $scope.addAddress=function(){
        $http.post("../address/add.do",$scope.entity).success(
            function (response) {
                alert(response.message);
    ...
    $scope.dele=function(id){
        //获取选中的复选框
        $http.post("../address/delete.do?ids="+id).success(
            function (response) {
                alert(response.message);
                window.location.reload();
            }
